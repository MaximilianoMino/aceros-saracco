...
export default function Services() {
  return (
    <section
      id="servicios"
      className="py-12 md:py-24 px-4 md:px-12 bg-gray-100 border-t border-gray-200"
    >
      <div className="max-w-[1184px] mx-auto">
        {/* Header */}
        <div className="text-center mb-8 md:mb-16 animate-fade-in-up">
          <h2 className="text-primary font-bold text-2xl md:text-4xl leading-tight md:leading-[50px] tracking-[-1px] md:tracking-[-2px] mb-2 md:mb-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {services.map((service, index) => (
            <div
              key={service.title}
              className="bg-white border border-gray-100 shadow-sm px-2 md:px-4 py-4 md:py-6 flex flex-col items-center gap-3 md:gap-4 hover:shadow-lg transition-all cursor-pointer group text-center animate-fade-in-up"
